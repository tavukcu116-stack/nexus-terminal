...
# ==========================================
# 📡 CACHE, STABLE SESSION & FALLBACK ENGINE
# ==========================================
...
# ==========================================
# 📊 ANA GÖRSELLEŞTİRME VE SEKME MOTORU
# ==========================================
def render_institutional_terminal(m_name, symbol):
    ...
    if not smc["kz"]: 
        st.markdown("<div class='blocked-node'>⏸️ EXECUTION SUSPENDED — OUTSIDE INSTITUTIONAL KILLZONE HOURS</div><br>", unsafe_allow_html=True)
...
# ==========================================
# 🏛️ INTERFACE HEADER & SEKME YAPILANDIRMASI
# ==========================================
